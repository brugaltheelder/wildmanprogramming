...
def get_kb_exercises(num_exercises, level_lower_bound = 0, level_upper_bound = 10,only_single_bell=False, reverse_RL=False, randomize_RL=True, print_urls=True, order_by_level=True):
    print("generating kettlebell workout")    
...
kettlebell_movements.append(exercise('stagger stance clean rear leg hand',['L','R'], level= 4, url='https://www.youtube.com/watch?v=SvoSVY831lU&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=110'))
kettlebell_movements.append(exercise('stagger stance clean front leg hand',['L','R'], level= 4, url='https://www.youtube.com/watch?v=SvoSVY831lU&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=110'))
kettlebell_movements.append(exercise('cross body clean',['L','R'], level=4 , url='https://www.youtube.com/watch?v=cw5mHcYDZ1o&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=111'))
kettlebell_movements.append(exercise('stagger stance cross body clean',['L','R'], level=5 , url='https://www.youtube.com/watch?v=Z0b6YDA5oW0&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=112'))
kettlebell_movements.append(exercise('outside clean',['L','R'], level=3 , url='https://www.youtube.com/watch?v=8OTjaoLsf-c&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=115'))
kettlebell_movements.append(exercise('walking cleans',['L','R'], level=3 , url='https://www.youtube.com/watch?v=gxEpA4CGagc&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=116'))
kettlebell_movements.append(exercise('inside circle press',['L','R'], level=3 , url='https://www.youtube.com/watch?v=uUmvC6VEXpQ&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=117'))
kettlebell_movements.append(exercise('outside circle press',['L','R'], level= 3, url='https://www.youtube.com/watch?v=phDCxF1Bs-I&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=118'))
kettlebell_movements.append(exercise('front clean to inside circle',['L','R'], level=4 , url='https://www.youtube.com/watch?v=fZXwdBRvIkg&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=120'))
kettlebell_movements.append(exercise('alternating circles with press',['L','R'], level=4 , url='https://www.youtube.com/watch?v=bF4uiBADLdA&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=121'))
kettlebell_movements.append(exercise('font clean to outside circle',['L','R'], level=4 , url='https://www.youtube.com/watch?v=hc8b8hXtYHA&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=122'))
kettlebell_movements.append(exercise('inside circle press to front clean and press',['L','R'], level=4 , url='https://www.youtube.com/watch?v=FcoMJn3AlFs&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=123'))
kettlebell_movements.append(exercise('outside circle press to front clean and press',['L','R'], level=4 , url='https://www.youtube.com/watch?v=o53tSQrsVXA&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=125'))
kettlebell_movements.append(exercise('high hand transition',['alternating'], level=3 , url='https://www.youtube.com/watch?v=RdlLPAYCkZQ&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=126'))
kettlebell_movements.append(exercise('high hand transition clean and press',['alternating'], level=4 , url='https://www.youtube.com/watch?v=Ik0U7DfvudM&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=127'))
kettlebell_movements.append(exercise('outside pendulum and press',['L','R'], level= 4, url='https://www.youtube.com/watch?v=wIkxWnQs_30&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=128'))
kettlebell_movements.append(exercise('around the leg high hand transition',['alternating'], level= 5, url='https://www.youtube.com/watch?v=1xAJ749SIrU&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=129'))
kettlebell_movements.append(exercise('inside circle with high hand transition',['alternating'], level=4 , url='https://www.youtube.com/watch?v=coDXMQjqfiY&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=130'))
kettlebell_movements.append(exercise('outside circle with high hand transition',['L','R'], level=4 , url='https://www.youtube.com/watch?v=Oud4B3oBeSU&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=131'))
kettlebell_movements.append(exercise('warrior clean (straight leg hand)',['L','R'], level=3 , url='https://www.youtube.com/watch?v=mxuRsKibYrQ&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=132'))
kettlebell_movements.append(exercise('inside dead clean',['L','R'], level=5 , url='https://www.youtube.com/watch?v=g8IuRD5w0rs&list=PLk4oYPJ7TXKg4lvvabXEn9BI4c9i696kx&index=133'))
kettlebell_movements.append(exercise('outside dead clean',['L','R'], level=4, url='https://www.youtube.com/watch?v=IRnzQbozjio'))
kettlebell_movements.append(exercise('high hand transition to stepback lunge',['alternating'], level=4 , url='https://www.youtube.com/watch?v=WLN_wsZZ_i0'))
